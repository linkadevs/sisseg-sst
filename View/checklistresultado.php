<?php
// Fallback seguro para evitar os Warnings
if (!isset($resultado) || !is_array($resultado)) {
    $resultado = [];
}

// Valores padrão para garantir que TODAS as chaves existam, evitando os "Undefined array key"
$defaults = [
    'classe_status' => 'nao_conforme',
    'status' => 'Nenhum resultado processado',
    'responsavel' => '---',
    'turno' => '---',
    'data' => date('d/m/Y H:i:s'),
    'progresso' => 0,
    'total_nao_conformes' => 0,
    'total_parcialmente_conformes' => 0,
    'itens_nao_conformes' => [],
    'itens_parcialmente_conformes' => [],
    'grupos' => [] // Array vazio impede o erro no foreach
];

// Mescla os dados reais (se existirem) com os padrões
$resultado = array_merge($defaults, $resultado);
?>
<!DOCTYPE html>
<html lang="pt-br">
            ...
            <div class="dados_resultado">
                ...
                <p>
                    ...
                    <strong id="nome_responsavel">
                        <?= htmlspecialchars($resultado["responsavel"]) ?>
                    </strong>
                </p>
                ...
                <p>
                    ...
                    <strong id="turno_escolhido">
                        <?= htmlspecialchars($resultado["turno"]) ?>
                    </strong>
                </p>
