    ...
    <main>
        ...
        <div class="search_div">
            <div class="search_input">
                ...
                <!-- O  form de busca deve ir para o controller -->
            ...
            <div class="buttons">
                <button type="submit" form="search">Limpar</button>
            </div>
        </div>
        <div class="grid">
            ...
            <?php else: ?>
                <?php foreach ($checklists as $checklist):
                    // Converte o status para a classe CSS correta
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const btnLimpar = document.querySelector('.buttons button'); 
                if(btnLimpar){
